...
/**
 * This is class based on
 * {@link com.jme3.shadow.DirectionalLightShadowRenderer}. I moved the post
 * frame code to pre frame and a few other things.
 *
 * @author Jan Ivenz
 */
public class DirectionalLightShadowPreFrameRenderer extends AbstractShadowPreFrameRenderer {
   ...
   */
  public DirectionalLightShadowPreFrameRenderer() {
    super();
  }
   ...
   */
  public DirectionalLightShadowPreFrameRenderer(AssetManager assetManager, int shadowMapSize, int nbSplits) {
   ...
   */
  public void setLight(DirectionalShadowLight light) {
    this.light = light;
  }
  ...
  /**
   * Enables the stabilization of the shadows's edges. (default is true) This
   * prevents shadows' edges to flicker when the camera moves However it can
   * lead to some shadow quality loss in some particular scenes.
   *
   * @param stabilize
   */
  ...
  public void read(JmeImporter im) throws IOException {
    ...
    light = (DirectionalShadowLight) ic.readSavable("light", null);
